...
The ASCII workflow diagram (`assets/ppiDCE.png`), generated by
[`assets/make_diagram.py`](assets/make_diagram.py) (edit the ASCII block there and
re-run it to regenerate the PNG), covers:
